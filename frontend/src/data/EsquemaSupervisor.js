...
export const ESQUEMA_SUPERVISOR = {
    ...
    infoClave: [
        {
            ...
            contenido: "Certificación como SUPERVISOR DE SEGURIDAD. Basado en el conocimiento y aplicación de la Norma Sectorial de Competencia Laboral (NSCL): 260401038 - V2 - 16/11/2022 - Supervisar servicios de seguridad de acuerdo con normativa.",
            icono: "Shield" 
        },
        {
        ...
        },
        {
            ...
            contenido: "Máximo Dos (2). Si el candidato no aprueba en primera instancia la evaluación integral, se programará una nueva fecha en un tiempo no mayor a 90 días calendario.",
    ...
    requisitos: [
        ...
        },
        {
            ...
            contenido: "Uso indebido de los certificados otorgados. Se aplica el Procedimiento para suspender o retirar la certificación de acuerdo a la naturaleza de la situación.",
            icono: "Warning"
        },
        {
        ...
        },
        {
            ...
            contenido: [
                ...
                "Duración máxima del examen: 240 minutos."
            ],
            icono: "Clock"
        }
    ],
    ...
    // Información de detalle de módulos (Opcional, para incluir en el Modal)
    detalleExamen: {
        teorico: {
        ...
        practico: {
            duracion: "120 minutos",
            items: [
                "Ejercicio informe de caso relacionado con la NSCL: 260401038 - V2 - 16/11/2022 - Supervisar servicios de seguridad de acuerdo con normativa.",
