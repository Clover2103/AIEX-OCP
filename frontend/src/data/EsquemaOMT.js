...
export const ESQUEMA_OMT = {
    // Títulos principales
    titulo: "OPERADOR DE MEDIOS TECNOLÓGICOS EN SEGURIDAD",
    ...
    infoClave: [
        {
            ...
            contenido: "Certificación basada en las NSCL: Monitorear sistemas de seguridad y Prestar servicios de respuesta al sistema de alarmas, según protocolos operativos y normativa.",
            icono: "Shield" 
        },
        {
    ...
    requisitos: [
        ...
        },
        {
            ...
            contenido: [
                "Direccionar condiciones de alarma.",
                "Procesar novedades.",
                "Caracterizar incidente.",
                "Acordonar área.",
                "Valorar hechos."
            ],
            icono: "ListChecks"
    ...
    detalleExamen: {
        teorico: {
            ...
            items: [
                "60 ítems de opción múltiple con única respuesta.",
        ...
        practico: {
            duracion: "120 minutos",
            items: [
                "Ejercicio de selección de informes, relacionado con las Normas sectoriales de competencia laboral de referencia.",
                "Ejercicio Informe de caso relacionado con las NSCL: Monitorear sistemas de seguridad y Prestar servicios de respuesta al sistema de alarmas.",
                "Ejercicio de selección de criterios relacionado con la labor del Operador de medios tecnológicos.",
