...
export const ESQUEMA_GESTOR_RIESGOS = {
    // Títulos principales
    titulo: "GESTOR DE ANÁLISIS DE RIESGOS Y PLANES DE SEGURIDAD",
    ...
    infoClave: [
        {
            ...
            contenido: "Certificación basada en las NSCL: Diseñar plan de seguridad de acuerdo con metodologías y normativa de seguridad privada y Estructurar esquemas de seguridad a personas.",
            icono: "Shield" 
        },
        {
    ...
    requisitos: [
        ...
        },
        {
            ...
            contenido: [
                ...
                "Estructurar estrategias de seguridad.",
                "Caracterizar información del protegido.",
                "Evaluar riesgos del protegido.",
                "Conformar equipo de protección."
            ],
            icono: "ListChecks"
        },
        {
    ...
    detalleExamen: {
        ...
        practico: {
            duracion: "120 minutos",
            items: [
                "Un (1) Informe de análisis de riesgos y vulnerabilidades.",
                "Un (1) ejercicio de construcción de Matriz de riesgos.",
                "Un (1) Informe de rutas.",
