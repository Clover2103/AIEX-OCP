...
import { useLogicFormR } from '../../hooks/useLogicFormR'; // Asegúrate de usar el nombre correcto
  ...
  return (
    <div className='container-form-registro'>
      ...
      <form id="frm" method="POST" onSubmit={handleSubmit} className="form-registro">
        ...
        <div class="form-group cont-text-el-solicitante col-md-12 pt-2">
        ...
        <div class="form-floating col-md-12 pt-2 " id="cont_codigo">
        ...
        <div class="form-group col-md-3 pb-2 w-100">
