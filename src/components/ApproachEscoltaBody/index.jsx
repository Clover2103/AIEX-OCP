          ...
          <table className="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  Certificación como ESCOLTA DE SEGURIDAD.
                  Basado en el conocimiento y aplicación de las Normas Sectoriales de Competencia Laboral (NSCL):
                  <ul>
                    <li>260401039 - V2 - 16/11/2022 - Proteger personas según normativa y esquemas de seguridad privada.</li>
                    <li>260401048 - V1 - 07/02/2022 - Evaluar riesgos del protegido de acuerdo con metodología técnica y normativa de seguridad y vigilancia.</li>
                  </ul>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <ul>
                    <li>Validar elementos.</li>
                    <li>Evaluar trayectoria.</li>
                    <li>Ejecutar plan de seguridad.</li>
                    <li>Documentar informe.</li>
                    <li>Verificar operativo.</li>
                    <li>Vigilar activos.</li>
                    <li>Tratar información.</li>
                    <li>Estimar riesgos.</li>
                    <li>Estructurar matriz.</li>
                    <li>Proyectar propuesta de esquema de seguridad.</li>
                  </ul>
                </td>
              </tr>
              <tr>
            ...
            <ul>
              ...
              <table className="table table-bordered">
                <tbody>
                  ...
                  <tr><td>Ejercicio de selección de informe, relacionado con la NSCL 260401039 - V2 - 16/11/2022 - Proteger personas según normativa y esquemas de seguridad privada.</td></tr>
